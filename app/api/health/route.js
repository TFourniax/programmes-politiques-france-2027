  ...
  try {
    ...
    return NextResponse.json({
      ...
      watch: {
        ...
        geminiQuotaOnly: Boolean(watchHealth.gemini_quota_only),
        pendingWork: watchHealth.pending_work,
        actionablePendingWork: watchHealth.actionable_pending_work ?? watchHealth.pending_work ?? 0,
        promotionRetriesPending: watchHealth.promotion_technical_retries_pending || 0,
        quotaRetriesPending: watchHealth.promotion_quota_retries_pending || 0,
        actionableRetriesPending: watchHealth.promotion_actionable_retries_pending ?? watchHealth.promotion_technical_retries_pending ?? 0,
        oldestPromotionRetryAgeHours: watchHealth.oldest_promotion_retry_age_hours || 0,
        promotionRetriesOverBudget: watchHealth.promotion_retries_over_budget || 0,
        promotionRetrySloHours: watchHealth.promotion_retry_slo_hours || 48,
