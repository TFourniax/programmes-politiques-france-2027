...
export function retrieveDeterministic(question, { limit = 10, minScore = 2.2 } = {}) {
  ...
  if (analysis.intent.unsupported) {
    return { results: [], debug: { answerable: false, reason: `unsupported_${analysis.intent.unsupportedReason}`, concepts: analysis.concepts, requestedEntities: analysis.requestedEntities, subjectTokens: analysis.subjectTokens, numbers: analysis.numbers, intent: analysis.intent, candidates: searchIndex.chunks.length, matched: 0, coherent: 0 } };
  }
