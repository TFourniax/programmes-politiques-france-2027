...
const QUERY_FILLER = new Set([
  ...
  "dire","dis","disponible","disponibles","donne","donner","exemple","exemples","explique",
  "faire","fais","info","infos","information","informations","interesse","interessent","parle",
  "parler","peux","peut","position","positions","propos","savoir","sujet","sujets","type","types",
  "vision","voudrais","voudrait"
]);
const INTENT_ONLY_TERMS = new Set([
  "candidat","candidats","candidature","candidatures","compare","comparaison","difference",
  "engagement","engagements","mesure","mesures","programme","programmes","propose","proposent",
  "proposition","propositions","prevoit","source","sources"
]);
