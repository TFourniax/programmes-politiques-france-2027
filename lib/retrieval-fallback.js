...
const INTERPRETATION_SCHEMA = {
  ...
  required: ["understood", "confidence", "intent", "entity_ids", "concept_ids", "numbers"],
  properties: {
...
export function sanitizeRetrievalInterpretation(raw, question) {
  ...
  return { confidence: "high", intent, entityIds, conceptIds, numbers };
}
...
Le serveur n'acceptera que confidence=high et revalidera ensuite le résultat avec son moteur déterministe.`;
