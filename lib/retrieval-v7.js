...
const COMMAND_WORDS = new Set([
  "compare", "comparer", "comparez", "comparons", "donne", "donner", "donnez", "explique", "expliquer", "expliquez",
  "indique", "indiquer", "indiquez", "liste", "lister", "listez", "montre", "montrer", "montrez", "presente", "presenter",
  "presentez", "resume", "resumer", "resumez"
]);
...
function namedPolicyQualifier(question) {
  ...
  // stemming so "Quelles" and "Compare" can never become fake policy names.
